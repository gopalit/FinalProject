...
namespace ProjectManager.NBench
{
    public class NBenchTest
    {
        ...
        #region TASK
        ProjectManager.Service.Controllers.TaskController taskController;
        ...
        public void NBench_GetParentTaskList()
        {
            ...
            taskController = new ProjectManager.Service.Controllers.TaskController();
        ...
        public void NBench_GetProjectDetails()
        {
            ...
            var result = projectController.GetProject("1");
            _objCounter.Increment();
        }
        #endregion
        ...
        public void NBench_GetUserDetails()
        {
            ...
            var result = userController.GetUsers("2");
            _objCounter.Increment();
        }
        #endregion
